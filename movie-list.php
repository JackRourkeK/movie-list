...
/**
 * Checks if Movie_List class exists or not, if not, then create an instance of the Movie_List class (Checking for PR New Added and Rebase and Squash Something Changed).
 */
